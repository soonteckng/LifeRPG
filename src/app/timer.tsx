...
const styles = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 16, backgroundColor: 'rgba(255, 255, 255, 0.07)', marginRight: 8, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.12)' },
  chipActive: { backgroundColor: '#2F6BFF', borderColor: '#2F6BFF' },
  chipText: { color: '#94A3B8', fontSize: 12, fontWeight: '600' },
  chipTextActive: { color: '#FFFFFF', fontWeight: 'bold' },
  notice: { backgroundColor: 'rgba(47, 107, 255, 0.16)', borderWidth: 1, borderColor: '#2F6BFF', padding: 10, borderRadius: 16, width: '100%', marginBottom: 12, alignItems: 'center' },
  noticeText: { color: '#10B981', fontSize: 12, fontWeight: 'bold' },
  presetRow: { flexDirection: 'row', gap: 6, marginBottom: 12, width: '100%' },
  preset: { flex: 1, paddingVertical: 12, borderRadius: 16, backgroundColor: 'rgba(255, 255, 255, 0.07)', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.12)', alignItems: 'center' },
  presetActive: { backgroundColor: '#2F6BFF', borderColor: '#2F6BFF' },
  ...
  timerCircle: { width: 220, height: 220, borderRadius: 110, borderWidth: 7, borderColor: '#5D8BFF', justifyContent: 'center', alignItems: 'center', marginVertical: 16, backgroundColor: 'rgba(255, 255, 255, 0.06)' },
  ...
  mainBtn: { backgroundColor: '#2F6BFF', paddingVertical: 16, borderRadius: 18, alignItems: 'center' },
  ...
  notesInput: { width: '100%', backgroundColor: 'rgba(255, 255, 255, 0.07)', color: '#F8FAFC', borderRadius: 18, padding: 14, height: 90, textAlignVertical: 'top', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.12)' },
});